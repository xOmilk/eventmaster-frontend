...
export function AdminPanelPage() {
    const [activeTab, setActiveTab] = useState<
        'visaoGeral' | 'organizadores' | 'aprovacoes' | 'comissoes' | 'relatorios'
    >('visaoGeral');
        ...
        <div className={styles.container}>
                ...
                <div className={styles.tabsContainer}>
                    {(
                        [
                            ...
                            { key: 'organizadores', label: 'Organizadores', badge: 2 },
                            { key: 'aprovacoes', label: 'Aprovações', badge: 3 },
                    ...
                    <>
                        ...
                        <div className={styles.quickActionsSection}>
                            ...
                            <div className={styles.quickActionsGrid}>
                                ...
                                onClick={() => navigate(PageRoutesName.administrador.getOrganizadores)}>
                                ...
                                <button className={styles.quickActionCard}
                                onClick={() => navigate(PageRoutesName.administrador.approveEvents)}>
                ...
                {activeTab === 'aprovacoes' && (
                    <div className={styles.placeholderSection}>
                        <p>Conteúdo de Aprovações virá aqui.</p>
                    </div>
                )}
                {activeTab === 'comissoes' && (
                    <div className={styles.placeholderSection}>
